...
<div class="col-md-4 mb-3">
    <img src="{{ Ghelper::glinkFoto($data->gambar) }}" class="img-thumbnail d-block w-100" style="width: 100%; height: 370px;">
</div>
<div class="col-md-8">
    <form action="{{ url('produk/edit/update') }}" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-7 col-md-9">
                <input type="text" class="form-control" id="singkatan" name="singkatan" placeholder="Singkatan barang.." value="{{ $data->singkatan }}">
            </div>
            @error('nama')
                <span class="text-danger ml-2">Nama barang harus di isi.</span>
            @enderror
        ...
        <div class="form-group row">
            ...
            <div class="input-group col-7 col-md-9">
                <input type="text" class="form-control" id="Berat" name="berat" placeholder="Berat barang.." value="{{ $data->berat }}">
            </div>
            @error('berat')
        ...
        <div class="form-group">
            <div class="input-group">
                <button class="btn btn-primary col-12">Edit Barang</button>
            </div>
        </div>
    </form>
</div>
